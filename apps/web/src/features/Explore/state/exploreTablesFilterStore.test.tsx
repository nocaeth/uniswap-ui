...
import { createExploreTablesFilterStore } from '~/features/Explore/state/exploreTablesFilterStore'

describe('exploreTablesFilterStore', () => {
  it('starts with empty filterString, DAY timePeriod, and UNSPECIFIED protocol', () => {
