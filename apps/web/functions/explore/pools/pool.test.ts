...
test.each(pools)('should inject metadata for valid pools', async (pool) => {
  ...
  expect(body).toContain(`<meta property="og:title" content="${pool.name} on NOCA" data-rh="true">`)
  ...
  expect(body).toContain(`<meta property="og:image:alt" content="${pool.name} on NOCA" data-rh="true">`)
  expect(body).toContain(`<meta property="twitter:card" content="summary_large_image" data-rh="true">`)
  expect(body).toContain(`<meta property="twitter:title" content="${pool.name} on NOCA" data-rh="true">`)
  expect(body).toContain(`<meta property="twitter:image" content="${pool.image}" data-rh="true">`)
  expect(body).toContain(`<meta property="twitter:image:alt" content="${pool.name} on NOCA" data-rh="true">`)
})
